...
import {useGetUserAdvocateFollowByIdQuery} from '../../../redux/api/api';
import { handleError } from '../../../../shared/authUtils';

const AdvocateFollowing = ({route}) => {
  const {id} = route.params || {};
  const [refresh, setRefresh] = useState(false);
  const {data: follow, loading, error} = useGetUserAdvocateFollowByIdQuery(id);
...
export default AdvocateFollowing;
