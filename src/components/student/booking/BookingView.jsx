...
import { useCancelSlotStudentMutation, useGetStudentSlotByIdQuery } from '../../../redux/api/api';
import { handleError } from '../../../../shared/authUtils';

const BookingView = ({route}) => {
  ...
  const {data, error, isLoading} = useGetStudentSlotByIdQuery(id);
  const [cancelSlotStudent] = useCancelSlotStudentMutation();
  ...
  const handleCancel = async () => {
    try {
      const res = await cancelSlotStudent({sloteId: id}).unwrap();
      console.log(res);
