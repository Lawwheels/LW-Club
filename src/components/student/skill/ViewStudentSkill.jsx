...
import { useDeleteStudentSkillMutation, useGetStudentQuery } from '../../../redux/api/api';

const ViewStudentSkill = () => {
  ...
  const [deleteStudentSkill] = useDeleteStudentSkillMutation();

  const handleDeleteSkill = async () => {
    try {
      const res = await deleteStudentSkill({id: selectedSkillId}).unwrap();
      console.log(res);
...
export default ViewStudentSkill;
