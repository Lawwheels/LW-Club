...
import {useAdvocateCertificateMutation, useStudentCertificateMutation} from '../../../redux/api/api';
...
export default AddStudentCertificate = ({navigation}) => {
  const [issueDate, setIssueDate] = useState(new Date());
  const [issueDatePicker, setIssueDatePicker] = useState(false);

  const [studentCertificate] = useStudentCertificateMutation();
        ...
        <Formik
          ...
          onSubmit={async (values, {setSubmitting}) => {
            try {
              ...
              const response = await studentCertificate(certificateToSubmit);
